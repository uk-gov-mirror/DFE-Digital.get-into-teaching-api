...
namespace GetIntoTeachingApiTests.Models
{
    public class TeachingEventTests
    {
        ...
        public void EntityAttributes()
        {
            ...
            type.GetProperty("CrmName").Should().BeDecoratedWith<EntityFieldAttribute>(a => a.Name == "msevtmgt_name");
        ...
        [Fact]
        public void Name_WhenSet_UpdatesCrmName()
        {
            ...
            teachingEvent.CrmName.Should().Be(name);
        }
    }
}
